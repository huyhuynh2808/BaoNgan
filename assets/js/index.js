document.addEventListener("DOMContentLoaded", function () {
  fetch("assets/forms/get_featured_products.php")
    .then((res) => res.json())
    .then((products) => {
      const container = document.getElementById("featured-products-list");
      if (!container) {
        console.error("Không tìm thấy phần tử có ID 'featured-products-list'");
        return;
      }
              ...
              <div class="col mb-4">
                <div class="product-card position-relative">
                  <div class="card-img product-img-hover position-relative">
                    ...
                    />
                    <a
                      href="coffee_detail.html?id=${
                        prod.id
                      }&name=${encodeURIComponent(prod.name)}"
